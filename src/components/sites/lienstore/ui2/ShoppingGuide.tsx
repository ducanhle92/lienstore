...
export const GUIDE_STEPS: Step[] = [
  ...
  { icon: "credit-card", vi: "Chọn hình thức thanh toán", ja: "お支払い方法を選ぶ", detailVi: "Chuyển khoản theo mã QR động của đơn (đã điền sẵn số tiền và mã thanh toán riêng), hoặc thanh toán khi nhận hàng. Hàng order cần thanh toán trước 100%.", detailJa: "注文番号入りQRコードでBIDVへ銀行振込、または代金引換。お取り寄せ商品は全額前払いです。" },
