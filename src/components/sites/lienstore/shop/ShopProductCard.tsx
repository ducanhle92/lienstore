    ...
    <li className={cn("group relative flex flex-col rounded-md border border-lien-line bg-white transition-shadow hover:shadow-[0_8px_24px_-12px_rgba(0,0,0,0.35)]", className)}>
      <div className="relative overflow-hidden rounded-t-md">
        ...
        {product.label ? (
          ...
          <img src={product.label.image} alt={product.label.name} draggable={false} className="pointer-events-none absolute top-1 left-1 z-[1] w-[30%] max-w-[96px] select-none sm:top-1.5 sm:left-1.5" data-testid="card-label" />
        ) : null}
