  ...
  return (
    <div
      className={cn(
        ...
        "[@media(hover:none)]:bottom-2 [@media(hover:none)]:left-auto [@media(hover:none)]:right-2 [@media(hover:none)]:translate-x-0 [@media(hover:none)]:translate-y-0 [@media(hover:none)]:scale-100 [@media(hover:none)]:opacity-100",
        className,
      )}
    >
      <span
      ...
      <button
        ...
        className={cn(
          "flex h-12 w-12 items-center justify-center rounded-full text-[19px] text-white shadow-[0_6px_16px_-6px_rgba(0,0,0,0.5)] transition-transform hover:scale-105 disabled:cursor-not-allowed [@media(hover:none)]:h-9 [@media(hover:none)]:w-9 [@media(hover:none)]:text-[15px]",
