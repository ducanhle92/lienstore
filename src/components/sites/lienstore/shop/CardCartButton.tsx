  ...
  return (
    <div
      className={cn(
        ...
        "opacity-0 translate-y-2 group-hover:translate-y-0 group-hover:opacity-100 focus-within:translate-y-0 focus-within:opacity-100 [@media(hover:none)]:translate-y-0 [@media(hover:none)]:opacity-100",
        className,
      )}
    >
      <span
        className={cn(
          "relative rounded px-2.5 py-1 text-[12px] font-semibold leading-4 whitespace-nowrap text-white shadow-sm",
