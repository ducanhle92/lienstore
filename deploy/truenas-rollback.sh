...
#   sudo sh truenas-rollback.sh lienstore-prod ghcr.io/ducanhle92/lienstore 1.5.1
#
...
set -eu
APP="${1:?app name}"; REPO="${2:?image repo, e.g. ghcr.io/ducanhle92/lienstore}"; VER="${3:?version, e.g. 1.5.1}"; TAG="${4:-latest}"
